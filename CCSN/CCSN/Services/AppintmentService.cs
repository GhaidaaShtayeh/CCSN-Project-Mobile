...
namespace CCSN.Services
{
    public class AppintmentService
    {
        ...
        //add follow up 
        public static async Task<IEnumerable<Appoitment>> GetFollowUp(string PatientID)
        {

            var url = (await firebaseClient
                     .Child($"Specalists/{PreferencesConfig.Id}/Patients/{PatientID}/Appointments").BuildUrlAsync());
